...
/*
PowerUsers Fetch power user objects
...
func (a *UserAPIService) UserBulkByAddressExecute(r ApiUserBulkByAddressRequest) (*map[string][]User, *http.Response, error) {
	...
	if r.addressTypes != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "address_types", r.addressTypes, "form", "")
	}
	if r.viewerFid != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "viewer_fid", r.viewerFid, "form", "")
	}
...
type ApiUserPowerLiteRequest struct {
	ctx context.Context
	ApiService *UserAPIService
	apiKey *string
}
...
// API key required for authentication.
func (r ApiUserPowerLiteRequest) ApiKey(apiKey string) ApiUserPowerLiteRequest {
	r.apiKey = &apiKey
	return r
}

func (r ApiUserPowerLiteRequest) Execute() (*UserPowerLiteResponse, *http.Response, error) {
	return r.ApiService.UserPowerLiteExecute(r)
}

/*
UserPowerLite Fetch power user FIDs

Fetches power users and respond in a backwards compatible format to Warpcast's deprecated power badge endpoint.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiUserPowerLiteRequest
*/
func (a *UserAPIService) UserPowerLite(ctx context.Context) ApiUserPowerLiteRequest {
	return ApiUserPowerLiteRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UserAPIService) UserPowerLiteExecute(r ApiUserPowerLiteRequest) (*UserPowerLiteResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UserAPIService.UserPowerLite")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
