...
func (r ApiFeedRequest) EmbedTypes(embedTypes []EmbedType) ApiFeedRequest {
...
type ApiFeedParentUrlsRequest struct {
	ctx context.Context
	ApiService *FeedAPIService
	apiKey *string
	parentUrls *string
...
// API key required for authentication.
func (r ApiFeedParentUrlsRequest) ApiKey(apiKey string) ApiFeedParentUrlsRequest {
	r.apiKey = &apiKey
	return r
}

// Comma separated list of parent_urls
func (r ApiFeedParentUrlsRequest) ParentUrls(parentUrls string) ApiFeedParentUrlsRequest {
	r.parentUrls = &parentUrls
	return r
}

// Include recasts in the response, true by default
func (r ApiFeedParentUrlsRequest) WithRecasts(withRecasts bool) ApiFeedParentUrlsRequest {
	r.withRecasts = &withRecasts
	return r
}

func (r ApiFeedParentUrlsRequest) ViewerFid(viewerFid int32) ApiFeedParentUrlsRequest {
	r.viewerFid = &viewerFid
	return r
}

// Include replies in the response, false by default
func (r ApiFeedParentUrlsRequest) WithReplies(withReplies bool) ApiFeedParentUrlsRequest {
	r.withReplies = &withReplies
	return r
}

// Number of results to retrieve (default 25, max 100)
func (r ApiFeedParentUrlsRequest) Limit(limit int32) ApiFeedParentUrlsRequest {
	r.limit = &limit
	return r
}

// Pagination cursor.
func (r ApiFeedParentUrlsRequest) Cursor(cursor string) ApiFeedParentUrlsRequest {
	r.cursor = &cursor
	return r
}

func (r ApiFeedParentUrlsRequest) Execute() (*FeedResponse, *http.Response, error) {
	return r.ApiService.FeedParentUrlsExecute(r)
}

/*
FeedParentUrls Retrieve feed based on parent urls

Retrieve feed based on parent urls

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiFeedParentUrlsRequest
*/
func (a *FeedAPIService) FeedParentUrls(ctx context.Context) ApiFeedParentUrlsRequest {
	return ApiFeedParentUrlsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return FeedResponse
func (a *FeedAPIService) FeedParentUrlsExecute(r ApiFeedParentUrlsRequest) (*FeedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FeedAPIService.FeedParentUrls")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiFeedTrendingRequest) Provider(provider FeedTrendingProvider) ApiFeedTrendingRequest {
	r.provider = &provider
	return r
}
...
type ApiFeedUserCastsRequest struct {
	ctx context.Context
	ApiService *FeedAPIService
	apiKey *string
	fid *int32
...
// API key required for authentication.
func (r ApiFeedUserCastsRequest) ApiKey(apiKey string) ApiFeedUserCastsRequest {
	r.apiKey = &apiKey
	return r
}

// FID of user whose recent casts you want to fetch
func (r ApiFeedUserCastsRequest) Fid(fid int32) ApiFeedUserCastsRequest {
	r.fid = &fid
	return r
}

// FID of the user viewing the feed
func (r ApiFeedUserCastsRequest) ViewerFid(viewerFid int32) ApiFeedUserCastsRequest {
	r.viewerFid = &viewerFid
	return r
}

// Number of results to retrieve (default 25, max 50)
func (r ApiFeedUserCastsRequest) Limit(limit int32) ApiFeedUserCastsRequest {
	r.limit = &limit
	return r
}

// Pagination cursor
func (r ApiFeedUserCastsRequest) Cursor(cursor string) ApiFeedUserCastsRequest {
	r.cursor = &cursor
	return r
}

// Include reply casts by the author in the response, true by default
func (r ApiFeedUserCastsRequest) IncludeReplies(includeReplies bool) ApiFeedUserCastsRequest {
	r.includeReplies = &includeReplies
	return r
}

// Parent URL to filter the feed; mutually exclusive with channel_id
func (r ApiFeedUserCastsRequest) ParentUrl(parentUrl string) ApiFeedUserCastsRequest {
	r.parentUrl = &parentUrl
	return r
}

// Channel ID to filter the feed; mutually exclusive with parent_url
func (r ApiFeedUserCastsRequest) ChannelId(channelId string) ApiFeedUserCastsRequest {
	r.channelId = &channelId
	return r
}

func (r ApiFeedUserCastsRequest) Execute() (*FeedResponse, *http.Response, error) {
	return r.ApiService.FeedUserCastsExecute(r)
}

/*
FeedUserCasts Retrieve casts for a user

Retrieve casts for a given user FID in reverse chronological order. Also allows filtering by parent_url and channel

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiFeedUserCastsRequest
*/
func (a *FeedAPIService) FeedUserCasts(ctx context.Context) ApiFeedUserCastsRequest {
	return ApiFeedUserCastsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return FeedResponse
func (a *FeedAPIService) FeedUserCastsExecute(r ApiFeedUserCastsRequest) (*FeedResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "FeedAPIService.FeedUserCasts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
