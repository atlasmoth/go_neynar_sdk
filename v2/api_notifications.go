...
func (r ApiMarkNotificationsAsSeenRequest) ApiKey(apiKey string) ApiMarkNotificationsAsSeenRequest {
	r.apiKey = &apiKey
	return r
}
...
func (r ApiNotificationsRequest) Type_(type_ NotificationType) ApiNotificationsRequest {
	r.type_ = &type_
	return r
}
