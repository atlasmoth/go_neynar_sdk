...
type UserSearchResponse struct {
	Result *UserSearchResponseResult `json:"result,omitempty"`
}
...
// SetResult gets a reference to the given UserSearchResponseResult and assigns it to the Result field.
