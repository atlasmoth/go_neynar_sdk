...
type OnChainEventSignerMigrated struct {
	...
	SignerMigratedEventBody *SignerMigratedEventBody `json:"signerMigratedEventBody,omitempty"`
}
...
// GetSignerMigratedEventBody returns the SignerMigratedEventBody field value if set, zero value otherwise.
func (o *OnChainEventSignerMigrated) GetSignerMigratedEventBody() SignerMigratedEventBody {
	if o == nil || IsNil(o.SignerMigratedEventBody) {
...
// GetSignerMigratedEventBodyOk returns a tuple with the SignerMigratedEventBody field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSignerMigratedEventBody gets a reference to the given SignerMigratedEventBody and assigns it to the SignerMigratedEventBody field.
...
func (o OnChainEventSignerMigrated) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SignerMigratedEventBody) {
