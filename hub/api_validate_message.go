...
/*
ValidateMessageApiService Validate a signed protobuf-serialized message with the Hub
...
*/
func (a *ValidateMessageApiService) ValidateMessage(ctx context.Context, body any, apiKey string) (ValidateMessageResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/validateMessage"
