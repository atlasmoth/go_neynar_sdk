...
// GetSignerEventBody returns the SignerEventBody field value if set, zero value otherwise.
func (o *OnChainEventSigner) GetSignerEventBody() SignerEventBody {
	if o == nil || IsNil(o.SignerEventBody) {
...
// GetSignerEventBodyOk returns a tuple with the SignerEventBody field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSignerEventBody gets a reference to the given SignerEventBody and assigns it to the SignerEventBody field.
