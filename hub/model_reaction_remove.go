...
// checks if the ReactionRemove type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReactionRemove{}

// ReactionRemove struct for ReactionRemove
type ReactionRemove struct {
	...
	Data *MessageDataReaction `json:"data,omitempty"`
}
...
// SetData gets a reference to the given MessageDataReaction and assigns it to the Data field.
func (o *ReactionRemove) SetData(v MessageDataReaction) {
	o.Data = &v
}

func (o ReactionRemove) MarshalJSON() ([]byte, error) {
...
func (o ReactionRemove) ToMap() (map[string]interface{}, error) {
...
type NullableReactionRemove struct {
	value *ReactionRemove
	isSet bool
}

func (v NullableReactionRemove) Get() *ReactionRemove {
	return v.value
}

func (v *NullableReactionRemove) Set(val *ReactionRemove) {
	v.value = val
	v.isSet = true
}

func (v NullableReactionRemove) IsSet() bool {
	return v.isSet
}

func (v *NullableReactionRemove) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReactionRemove(val *ReactionRemove) *NullableReactionRemove {
	return &NullableReactionRemove{value: val, isSet: true}
}

func (v NullableReactionRemove) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReactionRemove) UnmarshalJSON(src []byte) error {
	v.isSet = true
