...
/*
VerificationsApiService Get a list of verifications provided by an FID
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param apiKey API key required for authentication.
 * @param fid The FID being requested
 * @param optional nil or *VerificationsApiListVerificationsByFidOpts - Optional Parameters:
     * @param "Address" (optional.String) -  The optional ETH address to filter by
...
type VerificationsApiListVerificationsByFidOpts struct {
...
func (a *VerificationsApiService) ListVerificationsByFid(ctx context.Context, apiKey string, fid int32, localVarOptionals *VerificationsApiListVerificationsByFidOpts) (InlineResponse2004, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/verificationsByFid"
