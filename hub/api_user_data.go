...
/*
UserDataApiService Get UserData for a FID.
 ...
 * @param optional nil or *UserDataApiGetUserDataByFidOpts - Optional Parameters:
     * @param "UserDataType" (optional.Interface of UserDataType) -  The type of user data, either as a numerical value or type string. If this is omitted, all user data for the FID is returned
...
type UserDataApiGetUserDataByFidOpts struct {
    UserDataType optional.Interface
    PageSize optional.Int32
    Reverse optional.Bool
    PageToken optional.String
}

func (a *UserDataApiService) GetUserDataByFid(ctx context.Context, apiKey string, fid int32, localVarOptionals *UserDataApiGetUserDataByFidOpts) (InlineResponse2003, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v1/userDataByFid"
	...
	if localVarOptionals != nil && localVarOptionals.UserDataType.IsSet() {
		localVarQueryParams.Add("user_data_type", parameterToString(localVarOptionals.UserDataType.Value(), ""))
	}
