...
/*
FollowsApiService Gets all followers for a given FID
 ...
 * @param optional nil or *FollowsApiFollowersOpts - Optional Parameters:
...
type FollowsApiFollowersOpts struct {
    ViewerFid optional.Interface
    Limit optional.Int32
    Cursor optional.String
}

func (a *FollowsApiService) Followers(ctx context.Context, apiKey string, fid int32, localVarOptionals *FollowsApiFollowersOpts) (FollowResponse, *http.Response, error) {
	var (
...
/*
FollowsApiService Gets all following users of a FID
Gets a list of users who is following a given user in reverse chronological order.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param apiKey API key required for authentication.
 * @param fid FID of the user
 * @param optional nil or *FollowsApiFollowingOpts - Optional Parameters:
     * @param "ViewerFid" (optional.Interface of int32) -  fid of the user viewing this information, needed for contextual information.
     * @param "Limit" (optional.Int32) -  Number of results to retrieve (default 25, max 150)
     * @param "Cursor" (optional.String) -  Pagination cursor.
@return FollowResponse
...
type FollowsApiFollowingOpts struct {
    ViewerFid optional.Interface
    Limit optional.Int32
    Cursor optional.String
}

func (a *FollowsApiService) Following(ctx context.Context, apiKey string, fid int32, localVarOptionals *FollowsApiFollowingOpts) (FollowResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
