...
/*
NotificationsApiService Get mentions and replies
 ...
 * @param optional nil or *NotificationsApiMentionsAndRepliesOpts - Optional Parameters:
...
type NotificationsApiMentionsAndRepliesOpts struct {
    ViewerFid optional.Interface
    Cursor optional.String
}

func (a *NotificationsApiService) MentionsAndReplies(ctx context.Context, apiKey string, fid int32, localVarOptionals *NotificationsApiMentionsAndRepliesOpts) (MentionsAndRepliesResponse, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/farcaster/mentions-and-replies"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v MentionsAndRepliesResponse
...
/*
NotificationsApiService Get reactions and recasts
Get a list of reactions and recasts to the users’s casts in reverse chronological order
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param apiKey API key required for authentication.
 * @param fid fid of a user
 * @param optional nil or *NotificationsApiReactionsAndRecastsOpts - Optional Parameters:
     * @param "ViewerFid" (optional.Interface of int32) -  fid of the user viewing this information, needed for contextual information.
...
type NotificationsApiReactionsAndRecastsOpts struct {
    ViewerFid optional.Interface
    Limit optional.Int32
    Cursor optional.String
}

func (a *NotificationsApiService) ReactionsAndRecasts(ctx context.Context, apiKey string, fid int32, localVarOptionals *NotificationsApiReactionsAndRecastsOpts) (ReactionsAndRecastsResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/farcaster/reactions-and-recasts"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ReactionsAndRecastsResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
