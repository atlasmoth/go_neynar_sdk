...
func (a *ChannelAPIService) ChannelUsersExecute(r ApiChannelUsersRequest) (*UsersResponse, *http.Response, error) {
	...
	if r.hasRootCastAuthors == nil {
		return localVarReturnValue, nil, reportError("hasRootCastAuthors is required and must be specified")
	}

	parameterAddToHeaderOrQuery(localVarQueryParams, "id", r.id, "")
	parameterAddToHeaderOrQuery(localVarQueryParams, "has_root_cast_authors", r.hasRootCastAuthors, "")
	if r.hasCastLikers != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "has_cast_likers", r.hasCastLikers, "")
	}
	if r.hasCastRecasters != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "has_cast_recasters", r.hasCastRecasters, "")
	}
	if r.hasReplyAuthors != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "has_reply_authors", r.hasReplyAuthors, "")
	}
	if r.cursor != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "cursor", r.cursor, "")
	}
...
// Number of results to retrieve (default 25, max 200)
